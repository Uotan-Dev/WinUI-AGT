    ...
    public sealed partial class MindowsWidget : Window
    {
        ...
        private void ConfirmClick(object sender, RoutedEventArgs e)
        {
            if (Global.moreability == "installwin")
            {
                ...
                string wimpath = DrvPathTextBox.Text;
                if (wimpath != "")
                {
            ...
            {
                Mindows.Disdevice();//区分机型
                string drvpath1 = DrvPathTextBox.Text;
                if (drvpath1 != "")
                {
                    ConfirmButton.IsEnabled = false;
                    if (Global.sdanum == 0)
            ...
            {
                string regpath = DrvPathTextBox.Text;
                if (regpath != "")
                {
                    ConfirmButton.IsEnabled = false;
        ...
        public async void Moreability()
        {
            if (Global.moreability == "formatesp")
            {
                ...
                DrvPathTextBox.Visibility = Visibility.Collapsed;
                ChooseDrvButton.Visibility = Visibility.Collapsed;
        ...
        private async void ChooseDrvClick(object sender, RoutedEventArgs e)
        {
            if (Global.moreability == "installwin")
            {
                ...
                if (file != null) DrvPathTextBox.Text = file.Path;
                else DrvPathTextBox.PlaceholderText = "操作已取消";
            }
            else if (Global.moreability == "installdrive")
            {
                ...
                if (folder != null) DrvPathTextBox.Text = folder.Path;
                else DrvPathTextBox.PlaceholderText = "操作已取消";
            }
            else if (Global.moreability == "loadreg")
            {
